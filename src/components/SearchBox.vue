    ...
    <div>
        <form class="form-inline" action="/" method="post" @submit.prevent="submitForm">
            ...
            <div class="form-group mr-2 mb-2">
                <input id="search-input" ref="searchInput" :value="query" type="search" name="query" class="form-control" title="默认使用完全匹配。完全匹配无结果时使用模糊匹配。输入正则表达式可执行高级搜索。" @input="submitDebounce">
            </div>
